...
class tripleo::network::contrail::issu(
  ...
  $contrail_ssl_ca_certs_if_not_ipa = hiera('contrail_ssl_ca_certs_if_not_ipa', '/etc/contrail/ssl/certs/ca-cert.pem'),  $contrail_ssl_certfile        = hiera('contrail::service_cert_file', '/etc/contrail/ssl/certs/server.pem'),
  ...
  if $contrail_certificates_specs != undef {
    $contrail_ssl_ca_certs = '/etc/ipa/ca.crt'
      ...
      $contrail_ssl_ca_certs = $contrail_ssl_ca_certs_if_not_ipa
  }
