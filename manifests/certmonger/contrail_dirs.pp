...
# under the License.
#
# : = Class: tripleo::certmonger::contrail_dirs
#
...
class tripleo::certmonger::contrail_dirs(
  ...
  if $certificate_dir {
    ...
    File[$certificate_dir] ~> Certmonger_certificate<| tag == 'contrail-cert' |>
  }
  ...
  if $key_dir {
    ...
    File[$key_dir] ~> Certmonger_certificate<| tag == 'contrail-cert' |>
  }
}
